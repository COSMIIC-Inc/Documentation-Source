...
## Overview
The COSMIIC open source ecosystem is intended to become a community-driven effort. The goal of the governance structure is to define responsibilities and relationships to ensure that the ecosystem remains transparent and inclusive while also protecting the core intellectual property for all users.
...
This simplified diagram was created using the [Mermaid](https://mermaid.js.org/#/) diagramming and charting tool to dsecribe the responsibilities and interactions described below. The source code for the diagram is embedded in the markdown file generating this page.
...
- Non-Profit ↔ CWRU
  - Maintain non-exclusive license granting right to publish Core IP to open source
- Non-profit ↔ FDA
  - Give A Hand submits a Device Master File with corresponding open source details on cosmiic.org
- Users ↔ Non-Profit
  - Users access the open-source design (hosted/stewarded by the non-profit) through cosmic.org and its subdomains
  - Users may also contribute back improvements, documentation, or feedback.
  - Users make requests to Give A Hand for right to reference the Device Master File held at FDA
- Users ↔ For-Profit
  - Users purchase hardware and services from Open NeuroTech or other companies that implement the design.
  - Implantable hardware and externals + sterilization must be in line with information held in Device Master File
- Non-Profit ↔ For-Profit
  - Fiscal sponsorship
    - Give A Hand supports projects at Open NeuroTech which benefit the open source effort / community
  - Give A Hand purchases hardware and services from Open NeuroTech or other companies that implement the design.
Open NeuroTech corresponds with users and Give A Hand to communicate design/manufacturing/packaging changes.
- Users ↔ Users
...
- **Non-profit** - **[Give A Hand.tech](https://give-a-hand.tech)**
  ...
  - Maintains public access to the open source design and documentation as part o
  - Give A Hand Board of Directors: Brian Smith
- **For-Profit** - **[Open NeuroTech LLC](https://openneuro.tech)** and possible others
  ...
  - Open NeuroTech Personnel: Chris Rexroth and Dan Romano (currently engineers on COSMIIC grant project)
